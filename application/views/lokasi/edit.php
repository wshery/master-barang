            ...
            <header class="page-header">
                ...
                <div class="right-wrapper pull-right" style="padding-right: 3%;">
                    <ol class="breadcrumbs">
                        <li>
                            <a href="<?php echo site_url('stokout') ?>">
                                <i class="fa fa-home"></i>
                            </a>
                        </li>
                        <li><span>Stokout</span></li>
                        ...
                        <div class="panel-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row form-group">
                                    <div class="col-sm-12">
                                        <label>Lokasi</label>
                                        <input type="text" name="nama_lokasi" id="nama_lokasi" placeholder="Masukan Lokasi" value="<?= $lokasi['nama_lokasi']; ?>" class="form-control" onkeyup="this.value = this.value.toUpperCase();">
                                ...
                                <a href="<?php echo site_url('stokout/index') ?>" class="btn btn-warning">Cancel</a>
                            </form>
                        </div>
                    </section>
                </div>
