            ...
            <header class="page-header">
                ...
                <div class="right-wrapper pull-right" style="padding-right: 3%;">
                    <ol class="breadcrumbs">
                        ...
                        <li><span>Sub Menu Management</span></li>
                        <li><span>Add</span></li>
                    </ol>
                </div>
            </header>
                ...
                <div class="col-md-6">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="<?php echo site_url('Menu/storesubmenu'); ?>" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label>Title</label>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label>Menu</label>
                                        <select data-plugin-selectTwo class="form-control populate" id="menu_id" name="menu_id">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label>Url</label>
                                        <input type="text" name="url" id="url" placeholder="masterbarang/create" class="form-control">
                                        <?= form_error('menu', '<small class="text-danger pl-3">', '</small>') ?>
                                    </div>
                                </div>
                                <br />
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label>Icon</label>
                                        <input type="text" name="icon" id="icon" placeholder="ex : fa fa-folder-open" class="form-control">
                                        <?= form_error('menu', '<small class="text-danger pl-3">', '</small>') ?>
                                    </div>
                                </div>
                                <!-- <br />
