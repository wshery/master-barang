                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form action="<?php echo site_url('masterbarang/createkategori'); ?>" method="post">
                                ...
                                <input type="text" name="nama_kategori" id="name_kategori" placeholder="Masukan Kategori" class="form-control" onkeyup="this.value = this.value.toUpperCase();">
                                ...
                                <tbody>
                                    ...
                                    foreach ($kategori as $s) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url(''); ?>kategori/editmodal/<?= $s['id']; ?>">
                                                    <i class="fa fa-edit"></i>
                                                </a> |
                                                <a href="<?= base_url(''); ?>kategori/deletemodal/<?= $s['id']; ?>" onclick="return confirm('Sure want delete this data?')">
