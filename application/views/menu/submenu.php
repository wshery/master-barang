                ...
                <div class="col-xs-12">
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <h2 class="panel-title"><b>Sub Menu Management</b></h2>
                        </header>
                        <div class="panel-body">

                            <?= $this->session->flashdata('message'); ?>
                            <table class="table table-bordered table-striped mb-none" id="datatable-default">
                                <a href="<?php echo site_url('menu/createsubmenu'); ?>" type="button" class="mb-xs mt-xs mr-xs btn btn-sm btn-primary">
                ...
                <tbody>
                    ...
                    foreach ($subMenu as $usm) {
                        ...
                        <tr class="gradeX">
                            ...
                            <td><?= $usm['icon']; ?></td>
                            <td>
                                <a href="<?= base_url(''); ?>menu/edit/<?= $usm['id']; ?>">
                                    <i class="fa fa-edit"></i>
                                </a> |
                                <a href="<?= base_url(''); ?>menu/deletesubmenu/<?php echo $usm['id']; ?>" onclick="return confirm('Sure want delete this data?')">
