                ...
                <div class="col-md-6">
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <h2 class="panel-title"><b>FORM EDIT SUPIR</b></h2>
                        </header>
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" name="nama_supir" id="nama_supir" placeholder="Masukan nama supir" value="<?= $supir['nama_supir']; ?>" class="form-control" onkeyup="this.value = this.value.toUpperCase();">
