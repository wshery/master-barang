                        ...
                        <div class="panel-body">
                            ...
                            <form action="<?= base_url('user/editUser') ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <label>Nama</label>
                                        <input type="text" name="name" id="name" placeholder="Jhony" class="form-control" value="<?= $userm['name']; ?>">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" name="username" id="username" placeholder="jhony_ganteng" class="form-control" value="">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label>Email</label>
                                        <input type="text" name="email" id="email" placeholder="jhony@gmail.com | jhony@email.com" class="form-control" value="">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <select data-plugin-selectTwo class="form-control" name="role">
                                ...
                                <div class="row form-group">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="password" name="password1" id="password1" placeholder="minimal 8 character" class="form-control" value="<?= $this->input->post('password1') ?>">
                                        <?= form_error('password1', '<small class="text-danger pl-3">', '</small>') ?>
                                    </div>
                                    <div class="col-sm-6">
                                        <label>Password Confirmation</label>
                                        <input type="password" name="password2" id="password2" placeholder="samakan dengan pasword diatas" class="form-control" value="<?= $this->input->post('password2') ?>">
                                    </div>
                                </div>
                                <br />
