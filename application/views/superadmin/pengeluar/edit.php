                ...
                <div class="nano-content">
                    <nav id="menu" class="nav-main" role="navigation">
                        <ul class="nav nav-main">
                            ...
                            <li class="nav-active">
                                <a href="<?php echo base_url('masterbarang') ?>">
                ...
                <div class="col-md-6">
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <h2 class="panel-title"><b>FORM EDIT PENGELUAR</b></h2>
                        </header>
                        <div class="panel-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?= $pengeluar['id']; ?>">
                                <div class="row form-group">
                                    <div class="col-sm-12">
                                        <label>Pengeluar</label>
                                        <input type="text" name="nama_pengeluar" id="nama_pengeluar" placeholder="Masukan Pengeluar" value="<?= $pengeluar['nama_pengeluar']; ?>" class="form-control" onkeyup="this.value = this.value.toUpperCase();">
