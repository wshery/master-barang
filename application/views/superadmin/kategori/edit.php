                ...
                <div class="col-md-6">
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <h2 class="panel-title"><b>FORM EDIT KATEGORI</b></h2>
                        </header>
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" name="nama_kategori" id="nama_kategori" placeholder="ex : PSU" value="<?= $kategori['nama_kategori']; ?>" maxlgth="8en" class="form-control" onkeyup="this.value = this.value.toUpperCase();">
