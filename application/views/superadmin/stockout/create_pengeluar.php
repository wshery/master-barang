                        ...
                        <div class="panel-body">
                          <?= $this->session->flashdata('message'); ?>
                            <form action="<?php echo site_url('stockout/createpengeluar'); ?>" method="post">
                                <label>Dikeluarkan oleh</label>
                                <input type="text" name="nama_pengeluar" id="nama_pengeluar" required="required" placeholder="Masukan nama Pengeluar" class="form-control" onkeyup="this.value = this.value.toUpperCase();">
